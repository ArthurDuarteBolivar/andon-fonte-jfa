...
schedule.every().monday.at("17:00:00").do(capture_and_move_screenshot)
schedule.every().tuesday.at("17:00:00").do(capture_and_move_screenshot)
schedule.every().wednesday.at("17:00:00").do(capture_and_move_screenshot)
schedule.every().thursday.at("16:41:00").do(capture_and_move_screenshot)
schedule.every().friday.at("16:00:00").do(capture_and_move_screenshot)
